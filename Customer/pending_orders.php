          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Pending Order Requests <span>| Today</span></h5>
                 <p class="text-success text-center mb-3" style="font-size: 14px; font-weight: bold;"><?php  ?></p>
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        $dataQProducts = $isPerformCustOBJ->isRequestedRoom($cid);
                        $rowQProducts = $isPerformCustOBJ->isRequestedRoom($cid);
                        if ($rowQProducts > 0) {
                          $x = 0;
                     ...
                     <tr>
                        ...
                        <td><?=isset($values['req_block']) ? $values['req_block'] : 'N/A'; ?></td>
                        <td><?=isset($values['req_floor']) ? $values['req_floor'] : 'N/A'; ?></td>
                        <td><?=isset($values['room_size']) ? $values['room_size'] : 'N/A'; ?></td>
                        <td><?=isset($values['sale_price']) ? $values['sale_price'] : 'N/A'; ?></td>
                        <td><?=isset($values['oname']) ? $values['oname'] : 'N/A'; ?></td>

                        <td>
                          <a href="#"><img class="thumb-image" src="<?php echo '../files/rooms/'.(isset($values['url_image']) ? $values['url_image'] : 'default.jpg'); ?>" alt="" style="width: 120px; height: 120px;"></a>
                        </td>

                        <?php if (isset($values['saled_status']) && $values['saled_status'] == 1) { ?>
                          <td>
