          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Owners Lists <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $dataQOW = $isPerformOwnerOBJ->getMyOwInfor($params);
                        $rowQoW = $isPerformOwnerOBJ->getMyOwInfor($params);
                        if ($rowQoW > 0) {
                          // code...
                          $x = 0;
                          foreach ($dataQOW as $key => $value) {
                            // code...
                            $x++; ?>
                      <tr>
                        ...
                        <td><?= $value['state']; ?></td>
                         ...
                         <td>
                           <a href="up_owinfo.php?e=<?= base64_encode($value['owner_id']); ?>" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Edit</a>
                         </td>
                      </tr>
                         <?php } }else{ ?>
