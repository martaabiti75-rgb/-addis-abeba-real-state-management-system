...
<?php 
 ...
 $dataQ = $isPerformOwnerOBJ->getMyOwInfor($_SESSION['sessionID']);
 $rowQ = $isPerformOwnerOBJ->getMyOwInfor($_SESSION['sessionID']);
    foreach ($dataQ as $key => $value) {

      $IdRefferancedToOwner = $value['owner_uniq_id'];
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $dataQOW = $isPerformOwnerOBJ->isRequestedRoom($params);
                        $rowQoW = $isPerformOwnerOBJ->isRequestedRoom($params);
                        if ($rowQoW > 0) {
                          // code...
                          $x = 0;
                      ...
                      <tr>
                        ...
                        <?php }else{ ?>
                            <td>
                                <button type="button" class="btn btn-secondary approve" data-bs-toggle="modal" data-bs-target="#modalTop1" style="border-radius:3px; height:25px; font-size:10px; color: #ffffff;" id="<?=$values['req_id']; ?>">
                                 Not Approved
                                        </button>
                            </td>
                      <?php   } ?>
                      ...
                      <td>
                        <img src="../files/rooms/<?=isset($values['Block_Url']) ? $values['Block_Url'] : 'default.jpg'; ?>" class="card-img" width="100" height="120">
                      </td>
