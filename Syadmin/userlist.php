                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $param = 1;
                        $dataUserList = $isPerformAdminOBJ->fetchUserList();
                        $rowUserList = $isPerformAdminOBJ->fetchUserList();
                        if ($rowUserList > 0) {
                          // code...
                          $x = 0;
                      ...
                      <td>
                        <?php $status = (int)$value['account_status']; // cast to integer ?>

                        <?php if ($status == 1) : ?>
                            <!-- ACTIVE → user can be DEACTIVATED -->
                            <button 
                                class="btn btn-success btn-sm btn-open-deactivate"
                                data-email="<?= $value['email']; ?>"
                                data-fullname="<?= htmlspecialchars($value['fullname'], ENT_QUOTES); ?>"
                                data-method="deactivateUser"
                        ...
                        <?php else: ?>
                            ...
                            <button 
                                class="btn btn-danger btn-sm btn-open-activate"
                                data-email="<?= $value['email']; ?>"
                                data-fullname="<?= htmlspecialchars($value['fullname'], ENT_QUOTES); ?>"
                                data-method="activateUser"
                                style="border-radius:3px;height:25px;font-size:10px;">
                                De-active
                            </button>
                        <?php endif; ?>
                         ...
                         <td>
                           <a href="useredit.php?e=<?= base64_encode($value['email']); ?>" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Edit</a>
                         </td>
                      </tr>
                         <?php } }else{ ?>
