...
<?php 
  ...
  $rowQ = $isPerformMgOBJ->getSessionUser($_SESSION['sessionID']);
      foreach ($dataQ as $key => $value) {
        ...
        // $ow_email_mg = $value['ow_email_mg'];
        $IdRefferancedToOwner = $value['ow_email_mg'];
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        // $param = 1;
                        $dataQReal = $isPerformMgOBJ->getMyProperty($IdRefferancedToOwner);
                        $rowQReal = $isPerformMgOBJ->getMyProperty($IdRefferancedToOwner);
                        if ($rowQReal > 0) {
                          // code...
                          $x = 0;
