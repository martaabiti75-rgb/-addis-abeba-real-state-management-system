                 ...
                 <p class="text-success text-center mb-3" style="font-size: 14px; font-weight: bold;"><?php  ?></p>
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        $dataQProducts = $CommonOBJ->fetchFoodItems();
                        $rowQProducts = $CommonOBJ->fetchFoodItems();
                        if ($rowQProducts > 0) {
                          // code...
                          $x = 0;
                          foreach ($dataQProducts as $key => $value) {
                            // code...
                            $x++; ?>
                      <tr>
                        <th scope="row"><a href="#"><?= $x; ?></a></th>
                        <td><?= $value['food_name']; ?></td>
                        <td><a href="#" class="text-primary"><?= $value['category']; ?></a></td>
                        <td><a href="#" class="text-primary"><?= $value['price']; ?></a></td>
                        <td>
                        <img src="../files/foods/<?=$value['image_url']; ?>" class="card-img" style="max-width: 120px; max-height: 600px;">
                      </td>
