          ...
          <div class="card ">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                   ...
                   <p class="text-center text-success"> <?= $CommonOBJ->isRequestForOwner(); ?></p>
                  ...
                  <form class="row g-3" method="post" action="" id="ownerForm">
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="Address2" class="form-control" id="address2" value="" placeholder="Address 2" onscroll="City">
                      </div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="isRequestForOwner" id="isRequestForOwner">Submit</button>
                    </div>
                  </form>
