          ...
          <div class="card ">
                ...
                <div class="card-body">
                  ...
                  <!-- <span class="d-none d-lg-block">NiceAdmin</span> -->
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">Real Real State (Site Registration)</h5>
                  ...
                  <form class="row g-0 needs-validations" novalidate method="post" action="" id="forms">
                    ...
                    <p class="text-center text-success spanError errorALL"><?= $isPerformOwnerOBJ->RegisterProperty(); ?></p>
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="propertySize" class="form-control" id="propertySize" required>
                      </div>
                    ...
                    <div class="col-12 mt-5">
                      <button class="btn btn-primary w-100" type="submit" name="RegisterProperty" id="RegisterProperty">RegisterProperty</button>
                    </div>
                  </form>
