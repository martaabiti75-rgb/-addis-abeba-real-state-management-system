          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Saled Lists <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $dataQOW = $isPerformOwnerOBJ->SaledRoom($params);
                        $rowQoW = $isPerformOwnerOBJ->SaledRoom($params);
                        if ($rowQoW > 0) {
                          // code...
                          $x = 0;
                     ...
                     <tr>
                        <td><?=$x; ?></td>
                        <td class="cell">Room <?=$values['res_fullname']; ?></td>
                        <td class="cell">Room <?=$values['res_phone']; ?></td>
                        <td class="cell">Room <?=$values['res_room_no']; ?></td>
                        <td class="cell">Floor <?=$values['res_floor']; ?></td>
                        <td class="cell">Block <span><?=$values['res_block']; ?></span></td>
                        ...
                        <?php }else if($values['saled_status'] == 2){ ?> 
                          <td>
