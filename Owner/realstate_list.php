          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Property Lists <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th class="cell">PType</th>
                        <th class="cell">SubCity</th>
                        <th class="cell">Size</th>
                        <th class="cell">Blocks</th>
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        // $param = 1;
                        $dataQReal = $isPerformOwnerOBJ->getMyProperty($_SESSION['sessionID']);
                        $rowQReal = $isPerformOwnerOBJ->getMyProperty($_SESSION['sessionID']);
                        if ($rowQReal > 0) {
                          // code...
                          $x = 0;
                          foreach ($dataQReal as $key => $value) {
                            // code...
                            $x++; ?>
                      <tr>
                        ...
                        <td><a href="#" class="text-primary"><?= $value['PropertyAddress']; ?></a></td>
                        <td><?= $value['PropertySize']; ?></td>
                        <td><?= $value['Blocks']; ?></td>

                         <td>
                           <a href="up_property.php?p=<?= base64_encode($value['PropertyID']); ?>" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Edit</a>
                         </td>
                      </tr>
                         <?php } }else{ ?>
