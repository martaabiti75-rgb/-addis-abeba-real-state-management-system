                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $params = 0;
                        $dataQAOrders = $CommonOBJ->getActiveOrderLists($params);
                        $rowQAorders = $CommonOBJ->getActiveOrderLists($params);
                        if ($rowQAorders > 0) {
                          // code...
                          $x = 0;
                      ...
                      <tr>
                        <td><?=$x; ?></td>
                        <td><?=$values['order_name']; ?></td>
                        <td><?=$values['total_price']; ?></td>
                        <td><?=$values['order_code']; ?></td>
                        <td>
                          <?php 
                              if ($values['orderman_status'] == 0) { ?>
                                <a href="#" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Pending...</a>
                             <?php  }else if($values['orderman_status'] == 1){ ?>
                                <a href="#" class="btn btn-success btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Sent</a>
                            <?php  }else{ ?> 
                                <a href="#" class="btn btn-danger btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Rejected.</a>
                            <?php } ?>
                          
                        </td>
                      

                        <td><?php if ($values['seller_status'] == 0) { ?>
                          <a href="#" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Pending...</a>
                        <?php }else{ ?> 
                            <a href="#" class="btn btn-success btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Checked.</a>
                          <?php } ?>
                        </td>
                        <td><?php if ($values['deliver_status'] == 0) { ?>
                          <a href="#" class="btn btn-primary btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Pending...</a>
                        <?php }else{ ?> 
                            <a href="#" class="btn btn-success btn-sm" style="border-radius:3px; height:25px; font-size:10px;">Checked.</a>
                          <?php } ?>
                       ...
                       <td>
                            <a href="carts_detail.php?oc=<?=base64_encode($values['order_code']); ?>" class="btn btn-secondary btn-sm" style="border-radius:3px; height:25px; font-size:10px;" >get Detail</a>
                        </td>
                      </tr>
