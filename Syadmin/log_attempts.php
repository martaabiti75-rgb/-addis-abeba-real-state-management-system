...
?>
          ...
          <!-- Recent Sales -->
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">User Attempt Logs <span>| Today</span></h5>
                  <p class="text-success text-center mb-3" style="font-size: 14px; font-weight: bold;"><?= $isPerformAdminOBJ->AccountState(); ?></p>
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $param = 1;
                        $dataUserList = $isPerformAdminOBJ->getLogAttempts();
                        $rowUserList = $isPerformAdminOBJ->getLogAttempts();
                        if ($rowUserList > 0) {
                          // code...
                          $x = 0;
                      ...
                      <tr>
                            ...
                            <td><?= htmlspecialchars($values['ip_address']) ?></td>
                            <td><?= htmlspecialchars($values['device_name']) ?></td>
                            <td><?= htmlspecialchars($values['os_version']) ?></td>
                            <td><?= htmlspecialchars($values['browser_name']) ?></td>
                            <td><?= htmlspecialchars($values['location']) ?></td>
                            <td>
                              <?php if ($values['status'] === 'success') { ?>
                               <button style="border-radius:3px; height:25px; font-size:10px;" class="btn btn-success"><?= htmlspecialchars($values['status']) ?></td></button>
                              <?php }else{ ?> 
                                 <button style="border-radius:3px; height:25px; font-size:10px;" class="btn btn-danger"><?= htmlspecialchars($values['status']) ?></td></button>
                              <?php } ?>
                              
                            <td><?= htmlspecialchars($values['attempt_time']) ?></td>
                      </tr>
                         <?php } }else{ ?>
  ...
  <footer id="footer" class="footer" style="margin-top: 150px;">
    ...
    <div class="credits">
      ...
      Powered By <a href="https://t.me/zolaoff/">Cs Students</a>
    </div>
  </footer><!-- End Footer -->
